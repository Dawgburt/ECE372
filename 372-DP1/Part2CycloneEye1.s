...
@This program will use a pushbutton to trigger an interrupt
@First itteration
...
LDR R13, =STACK1		@Load ADDR for SVC Stack1
ADD R13, R13, #0x1000	@Point to top of SVC STACK1
CPS #0x12				@Switch to IRQ mode
LDR R13, =STACK2		@Load ADDR for IRQ STACK2
ADD R13, R13, #0x1000	@Point to top of IRQ STACK2
...
.align 2
SYS_IRQ: .WORD 0			@Location to store system IRQ ADDR
